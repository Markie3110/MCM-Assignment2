...
iTj(3,1,2) = 0;          iTj(3,2,2) = sin(theta); iTj(3,3,2) = cos(theta);  iTj(3,4,2) = 98;
iTj(4,1,2) = 0;          iTj(4,2,2) = 0;          iTj(4,3,2) = 0;           iTj(4,4,2) = 1;

% Joint 3 (2T3)
theta = deg2rad(-90);
iTj(1,1,3) = cos(theta); iTj(1,2,3) = 0;          iTj(1,3,3) = sin(theta);  iTj(1,4,3) = -105;
...
iTj(3,1,4) = -sin(theta); iTj(3,2,4) = 0;         iTj(3,3,4) = cos(theta);  iTj(3,4,4) = 326.5;
iTj(4,1,4) = 0;          iTj(4,2,4) = 0;          iTj(4,3,4) = 0;           iTj(4,4,4) = 1;

% Joint 5 (4T5)
theta = deg2rad(90);
iTj(1,1,5) = cos(theta); iTj(1,2,5) = 0;          iTj(1,3,5) = sin(theta);  iTj(1,4,5) = 35;
...
iTj(3,1,6) = -sin(theta); iTj(3,2,6) = 0;         iTj(3,3,6) = cos(theta);  iTj(3,4,6) = 385;
iTj(4,1,6) = 0;          iTj(4,2,6) = 0;          iTj(4,3,6) = 0;           iTj(4,4,6) = 1;

% Joint 7 (6T7)
theta = deg2rad(90);
iTj(1,1,7) = cos(theta); iTj(1,2,7) = 0;          iTj(1,3,7) = sin(theta);  iTj(1,4,7) = 153;

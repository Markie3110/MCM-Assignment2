...
iTj(1,1,3) = 0; iTj(1,2,3) = 0; iTj(1,3,3) = 1; iTj(1,4,3) = 1.05;
...
iTj(1,1,4) = 0; iTj(1,2,4) = -1; iTj(1,3,4) = 0; iTj(1,4,4) = 1.455;
iTj(2,1,4) = 0; iTj(2,2,4) = 0; iTj(2,3,4) = 1; iTj(2,4,4) = 0;
iTj(3,1,4) = -1; iTj(3,2,4) = 0; iTj(3,3,4) = 0; iTj(3,4,4) = 3.265;
...
iTj(3,1,6) = 1; iTj(3,2,6) = 0; iTj(3,3,6) = 0; iTj(3,4,6) = 3.85;
iTj(4,1,6) = 0; iTj(4,2,6) = 0; iTj(4,3,6) = 0; iTj(4,4,6) = 1;
%... for all the links of the manipulator%

iTj(1,1,7) = 0; iTj(1,2,7) = 0; iTj(1,3,7) = 1;  iTj(1,4,7) = 1.53;
